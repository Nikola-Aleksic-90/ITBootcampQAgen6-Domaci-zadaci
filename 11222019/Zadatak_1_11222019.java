...
public class Zadatak_1_11222019 {
	...
	// Proizvod
	public static Double proizvod3realna(Double pera, Double zika, Double mika) {
		double proizvod = pera * zika * mika;
		return proizvod;
	}
	
	// Minimum
	public static Double minimum3realna(Double pera, Double zika, Double mika) {
		double min = pera;
		if (zika<min) min = zika;
		if (mika<pera && mika<zika) min = mika;
		return min;
	}
